...
const searchTerms = [
    ...
    {
        text: "По логину сервера",
        value: "login"
    },
    {
        text: "По паролю сервера",
        value: "password"
    },
]
...
const AdminBilling = () => {
    ...
    const dataColumns = [
        "Пользователь", "Сумма", "Дата", "Номер услуги" , "Статус", "Ссылка на сервер", "Логин", "Пароль"
    ]
    ...
    const renderData = (v, i) => {
        return (
            <DataTableColumn key={i}>
                ...
                <td>{v.login}</td>
                <td className="p-right-40">{v.password}</td>
    ...
    return (
        <PageContainer>
            <DataTableContainer>
                <DataTableHeader>
                    <h1 className="a-main-menu a-main-menu-billing items-center display-flex" style={{marginRight: 20}}>Биллинг</h1>
                    ...
                    <Button onClick={() => addClick()} className="admin_add_button">Добавить Биллинг</Button>
                </DataTableHeader>
            ...
            <AdminFieldsPopup
                ...
                header={addOrEdit=="add" ? "Добавить Биллинг" : "Изменить Биллинг"}
